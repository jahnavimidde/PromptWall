# PromptWall Agent Instructions

## Project

PromptWall is an Enterprise AI Security Gateway built with Bun/Hono. It masks PII and secrets before forwarding requests to configured providers, then restores placeholders in responses where supported.
