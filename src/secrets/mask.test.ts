...
const sampleSecret = ["sk", "proj", "abc123def456ghi789jkl012mno345pqr678stu901vwx"].join("-");
const stripeSecret = ["sk", "live", "abc123def456ghi789jkl012"].join("_");
...
describe("secrets placeholder format", () => {
  ...
  test("increments counter per secret type", () => {
    const anotherSecret = ["sk", "proj", "xyz789abc123def456ghi789jkl012mno345pqr678"].join("-");
