...
// All schemas use .passthrough() to preserve fields PromptWall doesn't need to inspect
...
export const OpenAIRequestSchema = z
  .object({
    ...
    /**
     * PromptWall extension: selects which registered provider handles this request.
     * Defaults to "gemini". Stripped before forwarding upstream.
     * Supported values: "gemini" | "openai" | "anthropic" | "codex" | any registered id.
     */
    provider: z.string().optional(),
  })
  .passthrough();

/** Default provider used when none is specified in the request body. */
